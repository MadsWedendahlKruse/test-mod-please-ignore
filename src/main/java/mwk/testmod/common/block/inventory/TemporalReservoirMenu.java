...
public class TemporalReservoirMenu extends MachineMenu {

    public TemporalReservoirMenu(int containerId, Player player, BlockPos pos) {
        super(TestModMenus.TEMPORAL_RESERVOIR_MENU.get(), containerId, player, pos,
