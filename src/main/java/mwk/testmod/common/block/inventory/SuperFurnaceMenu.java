...
public class SuperFurnaceMenu extends CrafterMachineMenu {

    public SuperFurnaceMenu(int containerId, Player player, BlockPos pos) {
        super(TestModMenus.SUPER_FURNACE_MENU.get(), containerId, player, pos,
