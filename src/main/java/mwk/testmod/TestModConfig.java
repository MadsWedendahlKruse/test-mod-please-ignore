...
public class TestModConfig {
        ...
        public static final ModConfigSpec.IntValue ENERGY_CAPACITY_DEFAULT =
        ...
        private static final ModConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS =
                        BUILDER.comment("A list of items to log on common setup.")
                                        .defineListAllowEmpty("items",
                                                        ...
                                                        TestModConfig::validateItemName);
        ...
        private static boolean validateItemName(final Object obj) {
                return obj instanceof String itemName && BuiltInRegistries.ITEM
                                .containsKey(new ResourceLocation(itemName));
        }
        ...
        static void onLoad(final ModConfigEvent event) {
                ...
                items = ITEM_STRINGS.get().stream()
                                .map(itemName -> BuiltInRegistries.ITEM
                                                .get(new ResourceLocation(itemName)))
