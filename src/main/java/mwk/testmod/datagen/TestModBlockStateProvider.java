...
public class TestModBlockStateProvider extends BlockStateProvider {
    ...
    private void registerMultiBlockPart(MultiBlockPartBlock block, String name,
        CubeModel modelType) {
    ...
    private void registerMultiBlockController(MultiBlockControllerBlock block, String name,
        ControllerType type) {
    ...
    private void registerOreBlock(Block block, String name) {
        String modelPath = "block/" + name;
        // Create the model for the block
        models().withExistingParent(modelPath, "minecraft:block/cube_all").texture("all",
            modelPath);
