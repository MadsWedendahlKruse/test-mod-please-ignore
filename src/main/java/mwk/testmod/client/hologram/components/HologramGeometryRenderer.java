...
public class HologramGeometryRenderer {
    ...
    public void drawLine(PoseStack poseStack, float x1, float y1, float z1, float x2, float y2,
        ...
        vertexConsumer.vertex(pose.pose(), x1, y1, z1).color(r, g, b, a).normal(0.0F, 0.0F, 1.0F)
                .endVertex();
        vertexConsumer.vertex(pose.pose(), x2, y2, z2).color(r, g, b, a).normal(0.0F, 0.0F, 1.0F)
                .endVertex();
    }
    ...
    public void drawTriangle(PoseStack poseStack, Vec3 v1, Vec3 v2, Vec3 v3, float[] color1,
        ...
        vertexConsumer.vertex(pose.pose(), (float) v1.x, (float) v1.y, (float) v1.z)
                .color(color1[0], color1[1], color1[2], alpha1).endVertex();
        vertexConsumer.vertex(pose.pose(), (float) v2.x, (float) v2.y, (float) v2.z)
                .color(color2[0], color2[1], color2[2], alpha2).endVertex();
        vertexConsumer.vertex(pose.pose(), (float) v3.x, (float) v3.y, (float) v3.z)
                .color(color3[0], color3[1], color3[2], alpha3).endVertex();
        vertexConsumer.vertex(pose.pose(), (float) v3.x, (float) v3.y, (float) v3.z)
                .color(color3[0], color3[1], color3[2], alpha3).endVertex();
    }
